...
public class Inner01Main {
	...
	public static void main(String[] args) {
		...
		TestOuter.TestInner in4 = out.new TestInner(1001);
		TestOuter.TestInner in5 = out.new TestInner(1002);
		
		in4.printInnerValue();
		in5.printInnerValue();
		
		//
		TestOuter.TestInner in7 = new TestOuter(30).new TestInner(300);
		in7.printInnerValue();
		in7.printOuterValue();
