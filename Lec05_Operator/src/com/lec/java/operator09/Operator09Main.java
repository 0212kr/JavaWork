...
//		char ch3 = ch1 + ch2;	//	char + char = int
		char ch3 = (char)(ch1+ch2);	//	자동형변 int 타입을 강제로 char 타입으로 작성
...
//		int n4 = n1 + l1; //	int + long = long
		...
		float f3 = f1 + f2;	//	OK
		f3 = f1 + n1;	//	float 이 계산에 껴있으면 float 으로 형변
...
//		f3 = f1 + d1;	//	double 을 float 에 넣을경우 형변이 안되어서 불가 반대는 가능
