...
/* ArrayList<E>
	 ...
	 ///////
	  * 
	  * List<> - 중복 허용, 순서유지 (Index OK)
	  * 	ㄴ ArrayList<>
	  * 		참조 유리, 삽입, 삭제, 추가 불편
	  * 	ㄴ LinkedList<>
	  * 		참수 불리, 삽입, 삭제, 추가 용이
	  * 
	  * Set<> - 중복허용X, 순서유지X (인덱스 X)
	  * 	ㄴ HashSet<>
	  * 		검색속도에 특화
	  * 	ㄴ TreeSet<>
	  * 		저장할때부터 정렬됨
...
//C		// 데이터 추가(저장): add(element) 메소드 사용
		...
		list1.add(2, 700);	// (삽입)index 2번에 700을 넣겠습니다.
							// 2번에 700이들어오고 기존2번부터 나머지값은 한자리씩 밀려난다
		
	
		
//R		// 데이터 참조(읽기, 검색): get(index) 메소드 사용
...
//U		// 데이터 수정: set(index, element) 메소드 사용
		list1.set(2, 333);
