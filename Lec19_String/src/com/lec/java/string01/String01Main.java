...
public class String01Main {
	...
	public static void main(String[] args) {
		...
		str1 = str1.concat(str2);	//	변경하려면 덮어씌우기를 해야함
...
//		System.out.println(str1.charAt(20));	//	string 값도 index를 초과하면 죽습니다
		...
		System.out.println(str8.substring(2, 5));	//	2부터 5전까지 출력
		System.out.println(str8.substring(6));		//	6부터 출력
