...
//		System.out.println("\t gourp(0) : "+matcher.group(0)+ " { "+matcher.start(0)+"~"+matcher.end(0)+"}");
//		System.out.println("\t gourp(1) : "+matcher.group(1)+ " { "+matcher.start(1)+"~"+matcher.end(1)+"}");
//		System.out.println("\t gourp(2) : "+matcher.group(2)+ " { "+matcher.start(2)+"~"+matcher.end(2)+"}");
	...
	public static void regExpTest(String regex, String input) {
		System.out.println("정규 표현식 매칭테스트");
		...
		if (matchCount == 0)System.out.println("  X 매칭 없음 X");
		System.out.println();
	}
