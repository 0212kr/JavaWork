...
INSERT INTO t_dept2 VALUES(9100,'임시매장',1006,'서울지사'); -- 정상적으로 들어간다
INSERT INTO t_dept2 VALUES(9101,'임시매장',1006,'부산지사');
SELECT* FROM T_STUDENT; 
INSERT INTO T_STUDENT (STUDNO , NAME , ID ,DEPTNO1 ,GRADE ,PROFNO ) VALUES (9091, '김수진', 'sooplus',102,2,1004);
...
T_STUDENT 테이블에 위 생의 데이터를 추가하는 SQL 문을 작성하세요
SELECT * FROM T_STUDENT; 
-- Non Unique INDEX
