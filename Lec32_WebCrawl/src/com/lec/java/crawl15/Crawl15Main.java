...
class Station{
	...
	public ArrayList<Info> getStationList() {return stationList;}

	public Station(ArrayList<Info> stationList) {super();this.stationList = stationList;}

	public Station() {super();}

	public void setStationList(ArrayList<Info> stationList) {this.stationList = stationList;}
