 ...
 *  3. 프로젝트 우클릭 -> Configure Build Path - Library 탭 ->
 *   Add Jars (혹은라이브러리 추가) -> 추가할 라이브러리 선택
 */
...
public class Crawl01Main {
	...
	public static void main(String[] args) throws IOException {
		...
		Response response;	//respons 객체
		Document doc;		//JSOUP의 document object model 객체
		Element element;	// HTML의 element 표현 객체
...
//		403  권한에러 Forbidden : 파일권한, 읽기권한, SSL, IP, 등...
//		<--- 웹 크롤링 하다가 은근히 자주 마주치게 되는 에러
...
//		System.out.println(element);
		...
		//여러(복수의) 목록 크롤링 할시, 내가 원하는 개수만큼 크롤링 되었는지 우선 확인해보자
