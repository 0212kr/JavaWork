...
public class Method10Main {
	...
	public static void main(String[] args) {
		...
		int [] score = new int[10];	//	10명의 점수를 저장할 int형 배열
	...
	private static void inputScore(Scanner sc, int[] score) {
	...
	private static int calcTotal(int [] score) {
		int total = 0;
		for (int x : score) {
			total += x;
		}
	...
	private static double[] genRandom(int n) {
