...
//import com.lec.java.access04.MyDefault;
//다른 패키지의 default 클래스는 임포트자체가 안된다
...
public class Access03Main {
	...
	public static void main(String[] args) {
		...
		//다른 패키지에 있는 퍼블릭 클래스 (input필요)
		// => 인스턴스 생성 가능
		TestPublic2 t3 = new TestPublic2();
		
		//다른 패키지에있는 (default) 클래스
		// => 인스턴스 생성 불가
...
//		MyDefault2 t4;
		...
		//충돌되는 클래스와 클래스안에 생성자등은 전부 풀네임으로 작업해야한다.
