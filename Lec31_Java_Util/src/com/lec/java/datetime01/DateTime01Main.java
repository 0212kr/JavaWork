...
public class DateTime01Main {
	...
	public static void main(String[] args) throws Exception{
		...
		int year = now.getYear()+1900;	//연도는 1900이후 경과년도
		int month = now.getMonth();
		int day = now.getDate();
		int weekDay = now.getDay(); // 요일 0부터 일요일
...
//		String strMy1 = fmt.format(myFmt);
		...
		// 현재시각 ms로 표시 1000분의 1초
		System.out.println(baseTime);
		//1970-01-01 00:00:00 UTC 기준으로 경과된 ms
		
		long curTime = baseTime + 2000;//2초 뒤의 시간값
